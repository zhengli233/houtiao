  ...
  data: function () {
    return {
      tableData: [
        ...
        {id: 3, name: '云上长安战未央', weekday: [1, 2, 3, 4, 5, 6, 7], type: '日常'},
        ...
        {id: 16, name: '再战安徒恩', weekday: [], type: '活动', level: 4, startDate: '2020/05/21', endDate: '2020/07/16', content: '引导石，85ss套，100ss武器，灼炎荒古装扮'},
        {id: 17, name: '冒险家回归', weekday: [], type: '活动', level: 3, startDate: '2020/05/21', endDate: '2020/07/16', content: '12期天空，+10增幅券等'},
        {id: 18, name: '强者之路：抉择', weekday: [], type: '活动', level: 3, startDate: '2020/05/21', endDate: '2020/07/16', content: '新增匹配模式，武器装扮，光环，护石符文，袖珍罐等'},
        {id: 19, name: '周周惊喜乐开怀', weekday: [], type: '活动', level: 5, startDate: '2020/06/18', endDate: '2020/08/13', content: '深渊票，司南，100ss跨界石'},
        {id: 20, name: '夜市大亨', weekday: [], type: '活动', level: 4, startDate: '2020/06/18', endDate: '2020/07/16', content: '+8增幅券，黄金书等'},
        {id: 21, name: '卜算运势', weekday: [], type: '活动', level: 5, startDate: '2020/06/18', endDate: '2020/07/16', content: '引导石'},
        {id: 22, name: '阿拉德探险记第三季', weekday: [], type: '活动', level: 5, startDate: '2020/06/18', endDate: '2020/09/22', content: '龙袍'}]
    }
  },
  methods: {
    ...
    arraySpanMethod ({ row, column, rowIndex, columnIndex }) {
      if (columnIndex === 0) {
        if (rowIndex === 0) {
          ...
          return [10, 1]
        } else if ([16, 17, 18, 19, 20, 21].indexOf(rowIndex) !== -1) {
          return [0, 0]
        }
      } else if (columnIndex === 1) {
        if ([15, 16, 17, 18, 19, 20, 21].indexOf(rowIndex) !== -1) {
          return [1, 7]
        }
      } else {
        if ([15, 16, 17, 18, 19, 20, 21].indexOf(rowIndex) !== -1) {
